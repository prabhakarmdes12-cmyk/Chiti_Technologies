  ...
  return (
    <>
              ...
              {processSteps.map((step, i) => (
                <FadeIn key={step.number} delay={0.1 + i * 0.12}>
                  <div className="flex gap-7 items-start relative group">
                    <div className="w-11 h-11 rounded-full glass flex items-center justify-center shrink-0 text-primary/70 font-bold text-[13px]">
                      {step.number}
                    </div>
      ...
      <Container>
        <Section>
          <FadeIn>
            <div className="glass rounded-[2rem] p-10 md:p-16 relative overflow-hidden border border-white/[0.03]">
              <div
                className="absolute top-0 right-0 w-[350px] h-[350px] rounded-full"
                style={{
                  background: "radial-gradient(circle, rgba(186,158,255,0.04) 0%, transparent 70%)",
                }}
              />
