        ...
        <FadeIn>
          <div className="text-center mb-20">
            ...
            <h1 className="text-on-surface text-[2.5rem] md:text-[3.5rem] font-extrabold font-headline tracking-[-0.04em] leading-[1.08] mb-8">
              A small studio with{" "}
              <span className="gradient-text">big creative energy</span>
            </h1>
        ...
        <FadeIn delay={0.1}>
          <div className="grid grid-cols-3 gap-4 mb-24">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="glass rounded-2xl p-8 text-center group hover:-translate-y-1 transition-all duration-[600ms] ease-[cubic-bezier(0.22,1,0.36,1)] cursor-default"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {expertise.map((item, i) => (
              <FadeIn key={item.title} delay={0.08 + i * 0.1}>
                <div className="glass rounded-2xl p-8 group hover:-translate-y-1 transition-all duration-[600ms] ease-[cubic-bezier(0.22,1,0.36,1)]">
                  <div
