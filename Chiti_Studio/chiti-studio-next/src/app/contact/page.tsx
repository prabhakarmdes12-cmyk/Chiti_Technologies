      ...
      <Container size="wide">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-start">
          ...
          <FadeIn className="lg:col-span-7">
            <div className="glass rounded-[1.75rem] p-10 md:p-14">
                    ...
                    {projectTypes.map((type) => (
                      <button
                        ...
                        className={`px-6 py-2.5 rounded-full border text-[12px] font-medium transition-all duration-[500ms] ease-[cubic-bezier(0.22,1,0.36,1)] cursor-pointer ${
                          activeType === type
                            ? "border-primary/40 bg-primary/[0.08] text-primary/90 shadow-[0_0_16px_rgba(186,158,255,0.1)]"
          ...
          <aside className="lg:col-span-5 space-y-10">
            <FadeIn delay={0.2}>
              <div className="glass rounded-[1.75rem] p-9 relative overflow-hidden border border-white/[0.03]">
                <div
            ...
            <FadeIn delay={0.3}>
              <div className="px-2 space-y-10">
                ...
                <div className="p-7 glass rounded-xl border border-white/[0.03]">
