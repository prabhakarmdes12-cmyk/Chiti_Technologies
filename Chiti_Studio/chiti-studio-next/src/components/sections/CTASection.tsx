...
export default function CTASection() {
  return (
    <FadeIn>
      <div className="relative overflow-hidden rounded-[2rem] p-14 md:p-28 text-center glass">
        {/* Glow blobs — softer, more atmospheric */}
        <div
          className="absolute -top-48 -left-48 w-[500px] h-[500px] rounded-full"
          style={{
            background: "radial-gradient(circle, rgba(83,221,252,0.06) 0%, transparent 70%)",
        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
          <h2 className="text-on-surface text-[2.5rem] md:text-[3.5rem] font-extrabold font-headline tracking-[-0.04em] max-w-[720px] leading-[1.08]">
            ...
            <span className="text-primary/90">future</span>?
          </h2>
          <p className="text-on-surface-variant/60 text-[16px] max-w-[460px] leading-[1.7]">
            Limited intake for Q3. We prioritize partnerships that demand
