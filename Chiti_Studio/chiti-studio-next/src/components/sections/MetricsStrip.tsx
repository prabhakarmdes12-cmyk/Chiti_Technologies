...
const metrics = [
  { label: "Projects Delivered", value: "150", suffix: "+", accent: "text-primary/70" },
  { label: "Client Satisfaction", value: "99", suffix: "%", accent: "text-secondary/70" },
  { label: "Global Partners", value: "40", suffix: "+", accent: "text-tertiary/70" },
  { label: "Team Expertise", value: "12", suffix: "yrs", accent: "text-on-surface-variant/50" },
];
