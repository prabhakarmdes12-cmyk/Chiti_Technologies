...
export default function Button({
  ...
  const variants = {
    primary: cn(
      ...
      "hover:shadow-[0_0_30px_rgba(186,158,255,0.3),0_0_80px_rgba(186,158,255,0.08)]",
      "active:shadow-[0_0_16px_rgba(186,158,255,0.35)]",
      "btn-primary-wrap"
    ),
    secondary: cn(
      "border border-white/[0.08] text-on-surface",
      "bg-white/[0.03] backdrop-blur-sm",
      "hover:bg-white/[0.06] hover:border-white/[0.12] hover:shadow-[0_0_20px_rgba(186,158,255,0.06)]"
    ),
    ghost: cn(
